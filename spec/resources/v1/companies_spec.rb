...
describe "companies interface v1" do
    ...
    describe "companies/:id/full" do
      ...
      describe "response.body" do
        ...
        describe "json object" do
          ...
          it { should have_link("self").with_route("/companies/1/full") }
          it { should have_link("basic").with_route("/companies/1") }
    ...
    describe "/companies/:id" do
      ...
      describe "response.body" do
        ...
        describe "json object" do
          ...
          it { should have_link("full").with_route("/companies/1/full") }
